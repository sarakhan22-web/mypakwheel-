...
<br />
<h2 className="text-2xl font-bold text-black text-center underline">Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</h2>

<Image src={"/Corolla.webp"} alt="corolla" width={350} height={350} className="h-200 w-250 mx-auto my-6" />
<br />
    <h2 className=" text-3xl font-bold text-blue-900 text-center">Toyota Corolla</h2>
    <br />
