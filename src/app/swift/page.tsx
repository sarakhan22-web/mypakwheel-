...
const page = () => {
  return (
    ...
    <br />
    <h2 className="text-2xl font-bold text-black text-center underline">Suzuki Swift 2024 Price in Pakistan, Images, Reviews & Specs</h2>
    
    <Image src={"/Swift.jpg"} alt="corolla" width={350} height={350} className="h-200 w-250 mx-auto my-6" />
    <br />
    <h2 className="text-3xl font-bold text-blue-900 text-center">Suzuki Swift</h2>
    <br />
    ...
    <br />
    <p className='text-center text-green-600 text-2xl'>PKR 45,50,000</p>
    <br />
